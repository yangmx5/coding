...
public class TransferServiceImpl implements TransferService {
     ...
     * @date 2019/11/14
     */
    private AccountService from;
    private AccountService to;
    private Double money;
    private Long fromLogId;
    private Long toLogId;


    public TransferServiceImpl(AccountService from, AccountService to, Double money) {
        this.from = from;
        this.to = to;
        this.money = money;
    ...
    public static void main(String[] args) {
        ...
        AccountService fromAccount = new AccountServiceImpl();
        AccountService toAccount = new AccountServiceImpl();
